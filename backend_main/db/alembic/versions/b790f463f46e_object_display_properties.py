...
def upgrade():
    ...
    op.add_column('composite', sa.Column('show_description_composite', sa.Text()))
    op.execute("UPDATE composite SET show_description_composite='inherit'")
    op.alter_column('composite', 'show_description_composite', nullable=False)

    op.add_column('composite', sa.Column('show_description_as_link_composite', sa.Text()))
    op.execute("UPDATE composite SET show_description_as_link_composite='inherit'")
    op.alter_column('composite', 'show_description_as_link_composite', nullable=False)
...
def downgrade():
    ...
    op.drop_column('composite', 'show_description_as_link_composite')
    op.drop_column('composite', 'show_description_composite')
