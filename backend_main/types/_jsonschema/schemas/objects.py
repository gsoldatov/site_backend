from backend_main.types._jsonschema.schemas.common import object_id, name, description
from backend_main.types._jsonschema.schemas.object_data import object_type_and_data_options
from backend_main.types._jsonschema.schemas.objects_tags import added_tags, removed_tag_ids
