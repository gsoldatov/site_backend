...
def get_test_object(object_id, object_type = None, created_at = None, modified_at = None, \
    object_name = None, object_description = None, pop_keys = [], composite_object_with_subobject_data = False):
    """
    ...
    Returnes dictionary contains `object_id`, `object_type`, `created_at`, `modified_at`, `object_name`, `object_description` and `object_data` attributes.
    ...
    created_at = created_at or curr_time
    modified_at = modified_at or curr_time
    object_name = object_name or f"Object #{object_id}"
    object_description = object_description or f"Description to {object_name}"
    ...
    obj = {"object_id": object_id, "object_type": object_type, "created_at": curr_time, "modified_at": curr_time, 
           "object_name": object_name, "object_description": object_description, "object_data": object_data}
    for k in pop_keys:
        obj.pop(k, None)
    return obj
...
def get_objects_attributes_list(min_id, max_id):
    """
...
def add_composite_subobject(composite, object_id, row = None, column = None, selected_tab = 0, is_expanded = True, \
    ...
    if object_name != None or object_description != None or object_type != None or addedTags != None or removed_tag_ids != None or object_data != None:
        if None in (object_name, object_description, object_type, object_data):
