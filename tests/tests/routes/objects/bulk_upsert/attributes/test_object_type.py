...
async def test_try_changing_object_type(cli, db_cursor):
    ...
    insert_objects([
        get_test_object(1, object_type="link", owner_id=1, pop_keys=["object_data"]),
        get_test_object(2, object_type="markdown", owner_id=1, pop_keys=["object_data"]),
        get_test_object(3, object_type="to_do_list", owner_id=1, pop_keys=["object_data"]),
        get_test_object(4, object_type="composite", owner_id=1, pop_keys=["object_data"])
